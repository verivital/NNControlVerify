...
case 2
xmax(1) = network.weight{2}(1,1)*input.max(1)+network.weight{2}(1,2)*input.max(2)+network.weight{2}(1,3)*input.max(3)+network.weight{2}(1,4)*input.max(4)+network.weight{2}(1,5)*input.max(5)+network.bias{2}(1);
xmin(1) = network.weight{2}(1,1)*input.min(1)+network.weight{2}(1,2)*input.min(2)+network.weight{2}(1,3)*input.min(3)+network.weight{2}(1,4)*input.min(4)+network.weight{2}(1,5)*input.min(5)+network.bias{2}(1);
